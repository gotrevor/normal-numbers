...
- 2026-09-25 (review lap 92): **input (c) REFUTED in-kernel**; `twoPointElliottLog_of_archimedean_and_density`
  is vacuous.  Decomposition REVISED to `ElliottTwistRepair` ((c′) above a threshold + (e) below it);
